...
public class PopUpPesti extends Activity {
    ...
    EditText editPestiBrand;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
        setContentView(R.layout.activity_pop_up_pesti);
      ...
      /*  params.x = 0;
        ...
        editPestiBrand=findViewById(R.id.editPestiBrand);
    ...
    public void onClickOk(View view)
    {
        ...
        new AsyncSignUpBusinessPesti().execute();
    }
    ...
    private  class AsyncSignUpBusinessPesti extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PopUpPesti.this);
        ...
        protected Void  doInBackground(Void... params) {
            ...
            cred.add(new BasicNameValuePair("agril_product_category","Pesticides"));
            cred.add(new BasicNameValuePair("seed",null));//Agriculture,horticulture
            cred.add(new BasicNameValuePair("pesticides",editPestiBrand.getText().toString().trim()));// Pesticides brand
        ...
        protected void onPostExecute(Void result) {
            ...
            if(message.equals("Registration Successfull"))
            {
                ...
                Intent i = new Intent(PopUpPesti.this, Login.class);
                startActivity(i);
                finish();
