...
public class PopUpFerti extends Activity {
    ...
    EditText editFertiBrand;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
        setContentView(R.layout.activity_pop_up_ferti);
    ...
    /*    params.x = 0;
        ...
        editFertiBrand=findViewById(R.id.editFertiBrand);

    }
    public void onClickOk(View view)
    {
        Toast.makeText(this, "OK", Toast.LENGTH_SHORT).show();
        new AsyncSignUpBusinessFerti().execute();
    }
    ...
    private class AsyncSignUpBusinessFerti extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PopUpFerti.this);
        ...
        protected Void  doInBackground(Void... params) {
            ...
            cred.add(new BasicNameValuePair("agril_product_category","Fertiliser"));
            ...
            cred.add(new BasicNameValuePair("fertiliser",editFertiBrand.getText().toString().trim())); // Fertiliser brand
        ...
        protected void onPostExecute(Void result) {
            ...
            if(message.equals("Registration Successfull"))
            {
                ...
                Intent i = new Intent(PopUpFerti.this, Login.class);
                startActivity(i);
                finish();
