...
public class StateGovtAniResourceExtOff extends AppCompatActivity {

    RadioGroup rgAnimalResourcesPost;
    String str_animalresources_post="";
    ...
    EditText jurisdiction,expertise_in_options;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_state_govt_ani_resource_ext_off);
...
//        Log.d("ext_tracker:",ext_tracker);
        ...
        rgAnimalResourcesPost=findViewById(R.id.rgAnimalResourcesPost);
        ...
        rgAnimalResourcesPost.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                RadioButton rb2 = (RadioButton) group.findViewById(checkedId);
                if (null != rb2 && checkedId > -1) {
                    str_animalresources_post=  rb2.getText().toString();
                    Toast.makeText(StateGovtAniResourceExtOff.this, str_animalresources_post, Toast.LENGTH_SHORT).show();

                    // POP up alert
                    if (str_animalresources_post.equals("Prani Mitra")||str_animalresources_post.equals("LI"))
                    {
                        AlertDialog.Builder builder = new AlertDialog.Builder(StateGovtAniResourceExtOff.this);
                ...
                new CheckBoxGroup.CheckedChangeListener<String>() {
                    ...
                    public void onCheckedChange(ArrayList<String> values) {
                       /* Toast.makeText(StateGovtAniResourceExtOff.this,
                        ...
                        Toast.makeText(StateGovtAniResourceExtOff.this, str_expertise_in, Toast.LENGTH_SHORT).show();
                    }
                ...
                new CheckBoxGroup.CheckedChangeListener<String>() {
                    ...
                    public void onCheckedChange(ArrayList<String> values2) {
                       /* Toast.makeText(StateGovtAniResourceExtOff.this,
                        ...
                        Toast.makeText(StateGovtAniResourceExtOff.this, str_expertise_in_options, Toast.LENGTH_SHORT).show();
                      ...
                      /*  progressDialog.dismiss();*/
                        try {
                            ...
                            final ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(
                                    StateGovtAniResourceExtOff.this,R.layout.spinner_item,districtList);
                        ...
                        try {
                         ...
                         /*   Toast.makeText(SignUpFarmer_2.this, "arraylist_blockid", Toast.LENGTH_SHORT).show();
                            ...
                            final ArrayAdapter<String> spinnerArrayAdapter2 = new ArrayAdapter<String>(
                                    StateGovtAniResourceExtOff.this,R.layout.spinner_item_2,blockList);
                      ...
                      /*  progressDialog.dismiss();*/
                        try {
                            ...
                            final ArrayAdapter<String> spinnerArrayAdapter3 = new ArrayAdapter<String>(
                                    StateGovtAniResourceExtOff.this,R.layout.spinner_item_2,gpList);
    ...
    {
        new AsyncSignUpExtStateAnimalResource().execute();
    }
    private  class AsyncSignUpExtStateAnimalResource extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(StateGovtAniResourceExtOff.this);
        ...
        protected Void  doInBackground(Void... params) {
            ...
            if(ext_tracker.equals("extofftrackeron"))
            {
                ...
                cred.add(new BasicNameValuePair("depart_type", "Animal Resources"));
                cred.add(new BasicNameValuePair("depart_post", str_animalresources_post));
            ...
            if(message.equals("Registration Successfull")||message.equals("Update Successfull"))
            {
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        {
                            Intent i = new Intent(StateGovtAniResourceExtOff.this, Login.class);
                            startActivity(i);
                            finish();
                        }
                        else if(message.equals("Update Successfull"))
                        {
                            Intent i = new Intent(StateGovtAniResourceExtOff.this, NavdrawerRP.class);
                            startActivity(i);
                            finish();
                        }
                    }
