...
public class NavDrawerStudentR extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nav_drawer_student_r);
        ...
        imgeditProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(NavDrawerStudentR.this,EditProfileStudentResearcher.class));
            }
        });
        ...
        displaySelectedScreen(R.id.qna);
    }
...
*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.nav_drawer_student_r, menu);
        return true;
    }
            ...
            builder.setMessage("Do you want to log out ?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            startActivity(new Intent(NavDrawerStudentR.this,Login.class));
                            finish();
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            ...
            case R.id.qna:
                Toast.makeText(this, "qna fragment", Toast.LENGTH_SHORT).show();
            ...
            case R.id.openforum:
                Toast.makeText(this, "open forum activity", Toast.LENGTH_SHORT).show();
                break;
