...
public class BtypeDealsInS extends AppCompatActivity {
    ...
    String str_service_deals_in_product="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBoxMap.put((CheckBox) findViewById(R.id.checkBox1), "Repairing of small machines");
        checkBoxMap.put((CheckBox) findViewById(R.id.checkBox2), "Repairing of big machines");
        checkBoxMap.put((CheckBox) findViewById(R.id.checkBox3), "Insurance");
        checkBoxMap.put((CheckBox) findViewById(R.id.checkBox4), "Loan");
        checkBoxMap.put((CheckBox) findViewById(R.id.checkBox5), "Consultancy");
        checkBoxMap.put((CheckBox) findViewById(R.id.checkBox6), "Executant");
        checkBoxMap.put((CheckBox) findViewById(R.id.checkBox7), "Liaisoning");
        checkBoxMap.put((CheckBox) findViewById(R.id.checkBox8), "Machine Testing and Designing");
        checkBoxMap.put((CheckBox) findViewById(R.id.checkBox9), "Other");
        ...
        CheckBoxGroup<String> checkBoxGroup = new CheckBoxGroup<>(checkBoxMap,
                new CheckBoxGroup.CheckedChangeListener<String>() {
                    ...
                    public void onCheckedChange(ArrayList<String> values) {
                        ...
                        str_service_deals_in_product= sb.toString();
                        System.out.println(sb.toString());
                        Toast.makeText(BtypeDealsInS.this,str_service_deals_in_product,Toast.LENGTH_LONG).show();
                    }
        ...
        protected void onPostExecute(Void result) {
             ...
             */
                    ...
                    public void run() {
                        ...
                        Intent i = new Intent(BtypeDealsInS.this, Login.class);
                        startActivity(i);
                        finish();
