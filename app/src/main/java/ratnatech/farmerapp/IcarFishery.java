...
public class IcarFishery extends AppCompatActivity {
    ...
    String str_prawn_fish_other="";

    EditText fishery_expertise_in_options_other_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_icar_fishery);
        ...
        CheckBoxGroup<String> checkBoxGroup = new CheckBoxGroup<>(checkBoxMap,
                new CheckBoxGroup.CheckedChangeListener<String>() {
                    ...
                    public void onCheckedChange(ArrayList<String> values) {
                        ...
                        Toast.makeText(IcarFishery.this, str_expertise_in_options, Toast.LENGTH_SHORT).show();
                    }
        ...
        CheckBoxGroup<String> checkBoxGroup2 = new CheckBoxGroup<>(checkBoxMap2,
                new CheckBoxGroup.CheckedChangeListener<String>() {
                    ...
                    public void onCheckedChange(ArrayList<String> values2) {
                        ...
                        str_prawn_fish_other= sb.toString();
                        System.out.println(sb.toString());
                        Toast.makeText(IcarFishery.this, str_prawn_fish_other, Toast.LENGTH_SHORT).show();
                    }

                });

        fishery_expertise_in_options_other_text=findViewById(R.id.fishery_expertise_in_options_other_text);
    }

    public void onClickSubmit(View view)
    {
        new AsyncSignUpExtICARFishery().execute();
    }
    private  class AsyncSignUpExtICARFishery extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(IcarFishery.this);
        ...
        protected Void  doInBackground(Void... params) {
            ...
            if(ext_tracker.equals("extofftrackeron"))
            {
                ...
                cred.add(new BasicNameValuePair("expertise_in", "Fishery"));
                ...
                cred.add(new BasicNameValuePair("fishery_options", str_prawn_fish_other));
                cred.add(new BasicNameValuePair("fishery_other_text", fishery_expertise_in_options_other_text.getText().toString().trim()));
            ...
            if(message.equals("Registration Successfull")||message.equals("Update Successfull"))
            {
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        {
                            Intent i = new Intent(IcarFishery.this, Login.class);
                            startActivity(i);
                            finish();
                        }
                        else if(message.equals("Update Successfull"))
                        {
                            Intent i = new Intent(IcarFishery.this, NavdrawerRP.class);
                            startActivity(i);
                            finish();
                        }
                    }
